...
const auth = require ('./dev/authentication.js'); // grabs tokens and other stuff
const actuators = require ('./dev/actuators.js') // to find actuators and actuate them
const grabbers = require ('./dev/grabbers.js') // grabs tags, devices, actuatorsIDs, etc

const protocol = 'https://'
const hostname = 'api.cloogy.com'
const path = '/api/1.4'

const availablePower = 2.6; // magic number: available power in your house
...
async function getAverageAndActuate() {
    if (running === true) {
        ...
        let average;
        let timePassed = 0;
        let timeout = 120000; // two minutes
